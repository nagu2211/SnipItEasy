        ...
        <footer className="bg-white border-gray-200">
          <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
              ...
              <a href="https://my-portfolio.lat/" className="text-teal-600 underline hover:text-teal-500" target="_blank">
                here
              </a>
            </p>
            ...
            <ul className="mt-12 flex justify-center gap-6 md:gap-8">
              <li>
                <a href="https://www.instagram.com/santy_2211/" rel="noreferrer" target="_blank" className="text-gray-700 transition hover:text-gray-700/75">
                  <span className="sr-only">Instagram</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <svg viewBox="0 0 24 24" id="meteor-icon-kit__solid-instagram" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a href="https://github.com/nagu2211" rel="noreferrer" target="_blank" className="text-gray-700 transition hover:text-gray-700/75">
                  <span className="sr-only">GitHub</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <svg viewBox="0 -0.5 24 24" id="meteor-icon-kit__solid-github" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                      <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                      <g id="SVGRepo_iconCarrier">
                        <path
